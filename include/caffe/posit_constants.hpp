...
#define _G_NBITS_IP 16
#define _G_ESIZE_IP 2
...
#if _G_NBITS_IP == 16
#define _G_POSIT_SHIFT_AMOUNT_IP 0
#define _G_MAXREALP_IP 32767
#define _G_MINREALP_IP 1
#define POSIT_EXTRA_BITS_SHIFT_IP 49 // 64 - _G_NBITS + 1
#define POSIT_EXTRA_BITS_MASK_IP 0x0000FFFFFFFFFFFF
#define POSIT_HALFWAY_BIT_MASK_IP 0x0001000000000000

#if _G_ESIZE_IP == 1
#define _G_USEED_IP 4
#define _G_USEED_ZEROS_IP 2
#define POSIT_EXPONENT_MASK_IP 1
#define _G_MAXREAL_IP 2.684354560e+8
#define _G_MINREAL_IP 3.725290298e-9
#define _G_MAXREAL_INT_IP 0x4D800000
#define _G_MINREAL_INT_IP 0x31800000

#elif _G_ESIZE_IP == 2
#define _G_USEED_IP 16
#define _G_USEED_ZEROS_IP 4
#define POSIT_EXPONENT_MASK_IP 3
#define _G_MAXREAL_IP 7.205759e+16
#define _G_MINREAL_IP 1.387779e-17
#define _G_MAXREAL_INT_IP 0x5B800000
#define _G_MINREAL_INT_IP 0x23800000

#elif _G_ESIZE_IP == 3
#define _G_USEED_IP 256
#define _G_USEED_ZEROS_IP 8
#define POSIT_EXPONENT_MASK_IP 7
#define _G_MAXREAL_IP 5.192296859e+33
#define _G_MINREAL_IP 1.925929944e-34
#define _G_MAXREAL_INT_IP 0x77800000
#define _G_MINREAL_INT_IP 0x07800000

#elif _G_ESIZE_IP == 4
#define _G_USEED_IP 512
#define _G_USEED_ZEROS_IP 16
#define _G_MAXREAL_IP 2.695994667e+67
#define _G_MINREAL_IP 3.709206151e-68

#else
#define _G_USEED_IP 1 << (1 << _G_ESIZE)
#define _G_USEED_ZEROS_IP (1 << _G_ESIZE)
#define _G_POSIT_SHIFT_AMOUNT_IP (FP16_LIMB_SIZE - _G_NBITS)
#define _G_MAXREALP_IP ((1 << (_G_NBITS - 1)) - 1) << _G_POSIT_SHIFT_AMOUNT
#define _G_MINREALP_IP (1 << _G_POSIT_SHIFT_AMOUNT)
#define _G_INFP_IP 1 << (FP16_LIMB_SIZE - 1)
#define _G_MAXREAL_IP pow(_G_USEED, (_G_NBITS - 2))
#define _G_MINREAL_IP (1 / pow(_G_USEED, (_G_NBITS - 2)))
#endif
#endif
