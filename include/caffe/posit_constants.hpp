...
#define POSIT_EXTRA_BITS_SHIFT 47 // 64 - _G_NBITS + 1
#define POSIT_EXTRA_BITS_MASK 0x00003FFFFFFFFFFF
#define POSIT_HALFWAY_BIT_MASK 0x0000400000000000
...
#define _G_MINREAL 2.32830643654e-10
