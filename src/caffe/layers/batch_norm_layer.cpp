...
template <typename Dtype>
void BatchNormLayer<Dtype>::Reshape(const vector<Blob<fp16>*>& bottom,
      const vector<Blob<fp16>*>& top) {
  if (bottom[0]->num_axes() >= 1)
...
template <typename Dtype>
void BatchNormLayer<Dtype>::Forward_cpu(const vector<Blob<fp16>*>& bottom,
    const vector<Blob<fp16>*>& top) {
...
template <typename Dtype>
void BatchNormLayer<Dtype>::Backward_cpu(const vector<Blob<fp16>*>& top,
