...
void ConcatLayer<Dtype>::LayerSetUp(const vector<Blob<fp16>*>& bottom,
...
template <typename Dtype>
void ConcatLayer<Dtype>::Reshape(const vector<Blob<fp16>*>& bottom,
...
template <typename Dtype>
void ConcatLayer<Dtype>::Forward_cpu(const vector<Blob<fp16>*>& bottom,
      const vector<Blob<fp16>*>& top) {
...
template <typename Dtype>
void ConcatLayer<Dtype>::Backward_cpu(const vector<Blob<fp16>*>& top,
