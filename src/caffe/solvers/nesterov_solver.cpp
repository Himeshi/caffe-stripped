...
/*    // save history momentum for stepping back
  ...
  case Caffe::GPU: {
    ...
    caffe_expand_blob_w(this->history_[param_id]->count(),
        h_temp, this->history_[param_id]->gpu_data(),
		this->history_[param_id]->data_bias);
    ...
    caffe_compress_blob_w(this->history_[param_id]->count(), h_temp,
