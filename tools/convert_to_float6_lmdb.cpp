...
void convert_train_db() {
	...
	std::ostringstream s;
#ifdef MNIST
	s << "/home/himeshi/dl/caffe-stripped/examples/mnist/mnist_train_float6_lmdb";
#else
#ifdef CIFAR10
	s << "/home/himeshi/dl/caffe-stripped/examples/cifar10/cifar10_train_float6_lmdb";
#else
	printf("ERROR: Unkown database.\n");
#endif
#endif
...
void convert_test_db() {
	...
	std::ostringstream s;
#ifdef MNIST
	s << "/home/himeshi/dl/caffe-stripped/examples/mnist/mnist_test_float6_lmdb";
#else
#ifdef CIFAR10
	s << "/home/himeshi/dl/caffe-stripped/examples/cifar10/cifar10_test_float6_lmdb";
#else
	printf("ERROR: Unkown database.\n");
#endif
#endif
